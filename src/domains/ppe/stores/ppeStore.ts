...
export interface PpeRecord {
  id: string;
  employeeId: string;
  equipment: string; // e.g. Baret, Çelik Burunlu Ayakkabı
...
const INITIAL: PpeRecord[] = [
  { id: 'ppe1', employeeId: '1', equipment: 'Baret', dateGiven: '2025-01-01', nextRenewalDate: '2026-01-01', createdAt: '2025-01-01T00:00:00.000Z' },
  { id: 'ppe2', employeeId: '1', equipment: 'Çelik Burunlu Ayakkabı', dateGiven: '2025-01-01', nextRenewalDate: '2026-01-01', createdAt: '2025-01-01T00:00:00.000Z' },
  ...
  persist(
    (set, get) => ({
      ...
      addRecord: (data) => {
        ...
        const record: PpeRecord = { ...data, id: generateId(), createdAt: now };
      ...
      getRecordsByEmployee: (employeeId) => get().records.filter((r) => r.employeeId === employeeId),
    }),
